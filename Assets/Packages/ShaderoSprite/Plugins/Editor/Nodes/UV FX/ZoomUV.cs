...
public class ZoomUV : Node
{
    ...
    protected internal override void NodeGUI()
    {
        ...
        Variable = GUILayout.HorizontalSlider(Variable, 0.001f, 4);
        GUILayout.Label("Pos X (-3 to 3) " + Variable2.ToString("0.00"));
        Variable2 = GUILayout.HorizontalSlider(Variable2, -3, 3);
        GUILayout.Label("Pos Y (-3 to 3) " + Variable3.ToString("0.00"));
        Variable3 = GUILayout.HorizontalSlider(Variable3, -3, 3);
