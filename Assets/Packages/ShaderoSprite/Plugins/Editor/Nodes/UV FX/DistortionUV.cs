...
public class DistortionUV : Node
{
    ...
    protected internal override void NodeGUI()
    {
       ...
       Inputs[0].DisplayLayout(new GUIContent("UV", "Link with a UV"));
        ...
        Variable = GUILayout.HorizontalSlider(Variable, 0, 128);
        GUILayout.Label("Wave Y (0 to 128) " + Variable2.ToString("0.00"));
        Variable2 = GUILayout.HorizontalSlider(Variable2, 0, 128);
        GUILayout.Label("Dist X (1 to 10) " + Variable3.ToString("0.00"));
        Variable3 = GUILayout.HorizontalSlider(Variable3, 0, 1);
        GUILayout.Label("DistY (1 to 10) " + Variable4.ToString("0.00"));
        Variable4 = GUILayout.HorizontalSlider(Variable4, 0, 1);
