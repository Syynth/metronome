...
public class AnimatedOffsetUV : Node
{
    ...
    protected internal override void NodeGUI()
    {
        ...
        Variable = GUILayout.HorizontalSlider(Variable, -1, 1);
        GUILayout.Label("Offset Y (-1 to 1) " + Variable2.ToString("0.00"));
        Variable2 = GUILayout.HorizontalSlider(Variable2, -1, 1);
        GUILayout.Label("Zoom X (1 to 10) " + Variable3.ToString("0.00"));
        Variable3 = GUILayout.HorizontalSlider(Variable3, 1, 10);
        GUILayout.Label("Zoom Y (1 to 10) " + Variable4.ToString("0.00"));
        Variable4 = GUILayout.HorizontalSlider(Variable4, 1, 10);
        GUILayout.Label("Speed (-1 to 1) " + Variable5.ToString("0.00"));
        Variable5 = GUILayout.HorizontalSlider(Variable5, -1, 1);
