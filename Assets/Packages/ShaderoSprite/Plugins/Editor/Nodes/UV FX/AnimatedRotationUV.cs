...
public class AnimatedRotationUV : Node
{
    ...
    protected internal override void NodeGUI()
    {
        ...
        Variable = GUILayout.HorizontalSlider(Variable, -360f, 360);
        GUILayout.Label("Pos X (-1 to 2) " + Variable2.ToString("0.00"));
        Variable2 = GUILayout.HorizontalSlider(Variable2, -2, 2);
        GUILayout.Label("Pos Y (-1 to 2) " + Variable3.ToString("0.00"));
        Variable3 = GUILayout.HorizontalSlider(Variable3, -2, 2);
        GUILayout.Label("Intensity (0 to 4) " + Variable4.ToString("0.00"));
        Variable4 = GUILayout.HorizontalSlider(Variable4, 0, 4);
        GUILayout.Label("Speed (-10 to 10) " + Variable5.ToString("0.00"));
        Variable5 = GUILayout.HorizontalSlider(Variable5, -10, 10);
