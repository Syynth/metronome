...
namespace _ShaderoShaderEditorFramework
{
    ...
    public class BuildShader : Node
    {
        ...
        public static string BuildVertexShader(string shadername, string preview, string res, string ParametersLines, string ParametersDeclarationLines)
        {
            ...
            string First = "";
            First += "//////////////////////////////////////////////////////////////\n";
            First += "/// Shadero Sprite: Sprite Shader Editor - by VETASOFT 2017 //\n";
            First += "/// Shader generate with Shadero 1.5.0                      //\n";
            ...
            Second += "{\n";
            Second += "\n";
            Second += "Tags {\"Queue\" = \"Transparent\" \"IgnoreProjector\" = \"true\" \"RenderType\" = \"Transparent\" \"PreviewType\"=\"Plane\" \"CanUseSpriteAtlas\"=\"True\"}\n";
        ...
        public static string BuildLightShader(string shadername, string preview, string res, string ParametersLines, string ParametersDeclarationLines)
        {
            ...
            Second += "CGPROGRAM\n";
            Second += "\n";
            Second += "#pragma surface surf Lambert vertex:vert nofog nolightmap nodynlightmap keepalpha noinstancing\n";
