...
namespace _ShaderoShaderEditorFramework
{
    ...
    public class PatternMovementPack : Node
    {
        ...
        public void Function()
        {
            ...
            code += "result.a = lerp(1,result.a,v1) * rgba.a * lerp(mask.a,mask.r,v2);\n";
            code += "return result;\n";
            code += "}\n";
        }
        ...
        protected internal override void NodeGUI()
        {
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label("     ");
            Variable = GUILayout.HorizontalSlider(Variable, -1, 1, GUILayout.Width(190));
            GUILayout.EndHorizontal();
            ...
            GUILayout.Label(" ");
            GUILayout.Label("     ");
            Variable2 = GUILayout.HorizontalSlider(Variable2, -1, 1, GUILayout.Width(190));
            GUILayout.EndHorizontal();
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label(" ");
            Variable3 = GUILayout.HorizontalSlider(Variable3, -3, 3, GUILayout.Width(190));
            GUILayout.EndHorizontal();
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label(" ");
            Variable4 = GUILayout.HorizontalSlider(Variable4, 0, 1, GUILayout.Width(190));
            GUILayout.EndHorizontal();
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label(" ");
            Variable5 = GUILayout.HorizontalSlider(Variable5, 0, 1, GUILayout.Width(190));
            GUILayout.EndHorizontal();
