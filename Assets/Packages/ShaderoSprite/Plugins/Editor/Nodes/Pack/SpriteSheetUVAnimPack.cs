...
namespace _ShaderoShaderEditorFramework
{
    ...
    public class SpriteSheetUVAnimPack : Node
    {
        ...
        protected internal override void NodeGUI()
        {
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label("     ");
            Variable = GUILayout.HorizontalSlider(Mathf.Round(Variable), 2, 16, GUILayout.Width(190));
            ...
            GUILayout.Label(" ");
            GUILayout.Label("     ");
            Variable2 = GUILayout.HorizontalSlider((int)Variable2, 0, total, GUILayout.Width(190));
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label(" ");
            Variable3 = GUILayout.HorizontalSlider((int)Variable3, 0, total, GUILayout.Width(190));
            GUILayout.EndHorizontal();
