...
namespace _ShaderoShaderEditorFramework
{
    ...
    public class Generate_Spiral : Node
    {
        ...
        public void Function()
        {
            ...
            code += "float a = atan2(m.y, m.x);\n";
            code += "float v = sin(100.* (sqrt(r) - (0.02*LineSize) * a - .3 * t));\n";
        ...
        protected internal override void NodeGUI()
        {
            ...
            Variable = GUILayout.HorizontalSlider(Variable, -1, 2);

            GUILayout.Label("Pos Y (-1 to 2) " + Variable2.ToString("0.00"));
            Variable2 = GUILayout.HorizontalSlider(Variable2, -1, 2);

            GUILayout.Label("Size (0 to 2) " + Variable3.ToString("0.00"));
            Variable3 = GUILayout.HorizontalSlider(Variable3, 0, 2);
            ...
            Variable5 = GUILayout.HorizontalSlider(Variable5, -2, 2);
