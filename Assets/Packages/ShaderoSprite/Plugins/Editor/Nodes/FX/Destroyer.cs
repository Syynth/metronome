...
public class Destroyer : Node
{
    ...
    public void Function()
    {
        ...
        code += "c = txt*c;\n";
        code += "c.r = lerp(c.r, c.r*120.0*(1 - c.a), value);\n";
        code += "c.g = lerp(c.g, c.g*40.0*(1 - c.a), value);\n";
        code += "c.b = lerp(c.b, c.b*5.0*(1 - c.a) , value);\n";
    ...
    protected internal override void NodeGUI()
    {
        ...
        Variable2 = GUILayout.HorizontalSlider(Variable2, 0, 1);

        if (HDR)
        {
            rect.height = 300;
            GUILayout.Label("HDR: (0 to 2) " + HDRvalue.ToString("0.00"));
            HDRvalue = GUILayout.HorizontalSlider(HDRvalue, 0, 2);
        }
        else
        {
            rect.height = 260;
