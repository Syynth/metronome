...
public class AlphaIntensity : Node
{
    ...
    public void Function()
    {
        ...
        code += "{\n";
         code += "if (txt.a < 1) txt.a = lerp(0, txt.a, fade);\n";
        code += "return txt;\n";
        code += "}\n";
        code += "\n";
    ...
    protected internal override void NodeGUI()
    {
        ...
        GUILayout.Label("Fading: (0 to 3) " + Variable.ToString("0.00"));
        Variable = GUILayout.HorizontalSlider(Variable, -1, 3);
    ...
    public override bool Calculate()
    {
        ...
        string DefaultParameters1 = ", Range(0, 3)) = " + Variable.ToString();
