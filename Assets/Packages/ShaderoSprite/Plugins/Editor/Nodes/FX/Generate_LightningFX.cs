...
public class Generate_LightningFX : Node
{
    ...
    protected internal override void NodeGUI()
    {
        ...
        Variable = GUILayout.HorizontalSlider(Variable, -2, 2);
        ...
        Variable3 = GUILayout.HorizontalSlider(Variable3, 1, 8);

        GUILayout.Label("Number: (2 to 16) " + Variable4.ToString("0.00"));
        Variable4 = GUILayout.HorizontalSlider(Variable4, 2, 16);
        
        GUILayout.Label("Speed: (0 to 8) " + Variable5.ToString("0.00"));
        Variable5 = GUILayout.HorizontalSlider(Variable5, 0, 8);
