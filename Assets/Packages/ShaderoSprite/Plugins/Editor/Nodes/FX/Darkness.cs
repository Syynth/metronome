...
[Node(false, "RGBA/Color/Darkness")]
public class Darkness : Node
{
    [HideInInspector]
    public const string ID = "Darkness";
    [HideInInspector]
    ...
    {
        code = "";
        code += "float4 Darkness(float4 txt, float value)\n";
        code += "{\n";
        code += "txt.rgb -= value;\n";
        code += "return saturate(txt);\n";
        code += "}\n";
    }
    ...
    public override Node Create(Vector2 pos)
    {
        ...
        Function();
        Darkness node = ScriptableObject.CreateInstance<Darkness>();
        node.name = "Darkness";
    ...
    {
        Texture2D preview = ResourceManager.LoadTexture("Textures/previews/nid_darkness.jpg");
    ...
    public override bool Calculate()
    {
        ...
        string DefaultName = "Darkness_" + NodeCount;
        string DefaultNameVariable1 = "_Darkness_Fade_" + NodeCount;
        string DefaultParameters1 = ", Range(0, 1)) = " + Variable.ToString();
        string VoidName = "Darkness";
