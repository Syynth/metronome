...
o.rgb = (overlay.rgb * overlay.a + origin.rgb * origin.a * (1 - overlay.a)) / o.a;
...
float4 _PatternMovement_1 = PatternMovement(ZoomUV_1,_SourceNewTex_3,NewTex_3,0,0.589742,0.7433456);
NewTex_3 = lerp(NewTex_3,NewTex_3 + _PatternMovement_1,1.499897);
...
float4 SourceRGBA_1 = tex2D(_SourceNewTex_1, TwistUV_1);
float4 NewTex_2 = tex2D(_NewTex_2, i.texcoord);
float4 _PatternMovementMask_1 = PatternMovementMask(i.texcoord,_SourceNewTex_1,SourceRGBA_1,NewTex_2,0.06666369,-0.612818,0.4051326);
...
float4 NewTex_4 = tex2D(_NewTex_4,AnimatedMouvementUV_1);
float4 _Displacement_1 = DisplacementUV(DistortionUV_1,_SourceNewTex_2,0,NewTex_4.g,-0.5384693);
float4 _Displacement_2 = DisplacementUV(FlipUV_H(DistortionUV_1),_SourceNewTex_2,NewTex_4.r,NewTex_4.g,-0.0205172);
float4 OperationBlendMask_1 = OperationBlendMask(_Displacement_2, _Displacement_1, NewTex_2, 1); 
...
float4 OperationBlend_1 = OperationBlend(_PatternMovementMask_1, _PremadeGradients_1, 1); 
float4 OperationBlend_2 = OperationBlend(OperationBlend_1, NewTex_1, 0.7006093); 
float4 OperationBlend_3 = OperationBlend(NewTex_3, OperationBlend_2, 1); 
