...
float2 _Simple_Displacement_1 = SimpleDisplacementUV(_SpriteSheetUVAnimPack_1,0,NewTex_4.g*NewTex_4.a,0.07076474);
float2 FixUV_1 = FixSidesUV(_Simple_Displacement_1, i.texcoord);
float4 NewTex_5 = tex2D(_NewTex_5,FixUV_1);
_SpriteSheetUVAnimPack_1 = FixSidesUV(_SpriteSheetUVAnimPack_1, i.texcoord);
float4 NewTex_1 = tex2D(_NewTex_1,FixUV_1);
float _AutomaticLerp_Fade_1 = (1+cos(_Time.y *4*_AutomaticLerp_Speed_1))/2;
NewTex_5 = lerp(NewTex_5,NewTex_1, _AutomaticLerp_Fade_1);
...
NewTex_5 = lerp(NewTex_5,NewTex_5*NewTex_5.a + NewTex_2*NewTex_2.a,0.7179503 * NewTex_5.a);
float4 _ColorHSV_1 = ColorHSV(NewTex_5,_ColorHSV_Hue_1,_ColorHSV_Saturation_1,_ColorHSV_Brightness_1);
_SpriteSheetUVAnimPack_1 = FixSidesUV(_SpriteSheetUVAnimPack_1, i.texcoord);
